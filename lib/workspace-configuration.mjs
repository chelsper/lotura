...
const KNOWLEDGE_STATES = Object.freeze({
  "sanitized-working-draft": Object.freeze({
    description:
      "This workspace is still being prepared. Information may be incomplete or unverified, and a person must check it for sensitive information before it is shared.",
    label: "Working draft",
    tone: "warning",
  }),
