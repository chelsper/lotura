...
- For question suggestions, return exactly one short, conversational question: the one that best advances the highest-value unresolved gap in the supplied sources.
...
export function buildOpenAIDiscoveryEvaluationRequest(input) {
  ...
  return {
    ...
    text: {
      format: {
        name: "lotura_discovery_assistance_evaluation_v2",
